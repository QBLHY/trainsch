...
def main(sol_name, pic_name):
    #  read solution from solution.json
    with open(f'./data/{sol_name}.json', 'r') as f:
    ...
    # 保存图像
    plt.savefig(f'./pic/{pic_name}.png')

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--solution_name', help='Name of the solution', default='gb_solution',type=str)
    parser.add_argument('--pic_name', help='Name of the picture', default='gurobi',type=str)
    args = parser.parse_args()

    main(args.solution_name, args.pic_name)
